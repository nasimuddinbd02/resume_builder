    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Sidebar Tabs (visual layout) */}
          <div className="space-y-2">
            <div className="flex items-center gap-2 p-3 rounded-lg bg-primary/10 text-primary font-medium text-sm cursor-pointer border border-primary/20">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="glow-focus rounded-md">
                      <Input
                        ...
                        disabled // NextAuth credential emails are usually read-only
                      />
                    </div>
